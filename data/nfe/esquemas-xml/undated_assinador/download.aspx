...
<body onselectstart="return true;">
    ...
    <div id="divCentral">
        <form method="post" action="./download.aspx?tipoConteudo=OFrcUd5%2f%2fLg%3d" id="aspnetForm">
...
//]]>
    ...
    <a href="listaSubMenu.aspx?Id=BMPFMBoln3w=">Downloads</a>
      &gt;
      <span class="fonteCinza">Assinador</span>
    ...
    <?xml version="1.0" encoding="utf-8"?><div class="divTituloPrincipal" xmlns:dt="http://exslt.org/dates-and-times" xmlns:n="http://exslt.org/math"><label class="tituloPrincipal">Assinador</label></div><div class="indentacaoConteudo" xmlns:dt="http://exslt.org/dates-and-times" xmlns:n="http://exslt.org/math">As mensagens enviadas ao Portal da Secretaria de Fazenda Estadual são documentos eletrônicos elaborados no padrão XML e devem ser assinados digitalmente com um Certificado Digital que contenha o CNPJ do estabelecimento emissor da NF-e objeto do pedido. Como forma de disseminar o uso dos Certificados Digitais e da própria tecnologia de Assinatura Digital, foi desenvolvido um produto chamado &quot;AssinadorRS&quot;. <br />
<br />
  O AssinadorRS tem o objetivo de difundir o uso desta tecnologia, aderente aos padrões previstos no Projeto NF-e. </div><table class="tabelaFundoBege" xmlns:dt="http://exslt.org/dates-and-times" xmlns:n="http://exslt.org/math"><caption>Download da Última Versão</caption><tr><td><a target="blank" href="&#xD;&#xA;                          exibirArquivo.aspx?conteudo=dUfiY0nIxww="><img onmouseover="javascript: trocarImagem(this)" onmouseout="javascript: trocarImagem(this)" src="imagens/instalar_Assinador_NFe_Off.png"></img></a></td><td><span class="tituloConteudoConsulta">Funcionalidades do Aplicativo:</span>
<ol>
<li><span>Assinatura digital de Nota Fiscal e de Lote de Notas, no padrão XML Signature da W3C;</span></li>
<li><span>Verificação da Assinatura Digital de Nota Fiscal e de Lote de Notas;</span></li>
<li><span>Geração de Lotes de Notas Fiscais, a partir das NF-e selecionadas;</span></li>
<li><span>Visualização das Notas Fiscais e Lotes selecionados.</span></li></ol></td></tr></table><table class="tabelaFundoBege" xmlns:dt="http://exslt.org/dates-and-times" xmlns:n="http://exslt.org/math"><caption>Pré-Requisitos de Instalação</caption><tr><td style="width: 25%"><a target="blank" href="https://www.microsoft.com/pt-br/download/details.aspx?id=1639">Framework .NET Versão 2.0</a></td><td>Para executar o programa Assinador é necessária a instalação prévia do Microsoft .NET Framework Version 2.0 Redistributable Package (x86)</td></tr></table>
